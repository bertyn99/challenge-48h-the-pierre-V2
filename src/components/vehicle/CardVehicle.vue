...
<template>
  <router-link :to="urlVehicle">
    <div v-if="vehicle != null" class="group w-32 h-64 pt-2 m-2 overflow-hidden">
      <img :src="imgUrl"
        class="object-contain  w-full h-3/4 aspect-[4/3] transition-all delay-150 hover:-translate-y-1 hover:scale-110"
        alt="" />
